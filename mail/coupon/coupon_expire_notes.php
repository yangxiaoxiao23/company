...
return array('subject' => '您的优惠码即将到期！','content' => $top . '
	...
	<tr>
		<td bgcolor="#E1F2FC">
			<table width="600" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><p style="font-size:12px; line-height:16px; color:#223C6A"><span
								style="font-size:14px; font-weight:700;"> 亲爱的顾客{CustomerName}您好！ </span><br/><br/>
							截至{ToDate} 您有已激活未使用优惠券{Yuan}元，于{ExpireDate}即将到期，请在有效期内使用。</p></td>
				</tr>
			</table>
		</td>
	</tr>
