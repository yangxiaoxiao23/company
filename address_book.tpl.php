...
?>
    ...
    <div>
      <span style="float: right;"><?php echo html::button_jquery_ui(SMALL_IMAGE_BUTTON_EDIT, 'document', html::href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'edit=' . $addresses['address_book_id'], 'SSL')) . ' ' . html::button_jquery_ui(SMALL_IMAGE_BUTTON_DELETE, 'trash', html::href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'delete=' . $addresses['address_book_id'], 'SSL')); ?></span>
...
?>
    ...
    <span class="buttonAction"><?php echo html::button_jquery_ui(IMAGE_BUTTON_ADD_ADDRESS, 'home', html::href_link(FILENAME_ADDRESS_BOOK_PROCESS, '', 'SSL'), 'primary'); ?></span>
